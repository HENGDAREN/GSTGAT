...
parser.add_argument('--Pre_len', type=int, default=7, help='model predict length')
...
def main(args):
    ...
    label = test_label
    np.save(r'D:/gzh/GAT-sst/result/predict/{}_{}_pred.npy'.
            format('bohai', args.Pre_len), pred)
    np.save(r'D:/gzh/GAT-sst/result/predict/{}_{}_label.npy'.
                            ...
                            for embed in embed_dim_list:
                                for learning_rate in learning_rateList:
                                    for weight_decay in weight_decaylist:
                                        log_file = 'D:/gzh/GAT-sst/result/log/{}_{}_{}_{}_{}_{}_{}_{}_log'. \
                                            format(file, i, p, channels, dropout, gamma, order, embed)
                                        model_save_path = 'D:/gzh/GAT-sst/result/model/{}_{}_{}_{}_{}_{}_{}_{}'. \
                                            format(file, i, p, channels, dropout, gamma, order, embed)
